...
class IssueRequest extends Model
{
    ...
    public function saveIssueRequest($request = array()){
        ...
        $issuerequest->raised_by = $request->input('raised_by','');
        $issuerequest->building_id = $request->input('building_id','');
        $issuerequest->floor_id = $request->input('floor_id','');
        $issuerequest->priority = $request->input('priority','');
        $issuerequest->room_id = $request->input('room_id','');
        $issuerequest->tenant_id = $request->input('tenant_id','');
